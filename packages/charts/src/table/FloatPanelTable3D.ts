...
import { TableRow } from './FlipCardTable3D'

export interface FloatPanelTable3DOptions extends ChartOptions { columns?: string[]; panelWidth?: number; rowHeight?: number }

export class FloatPanelTable3D extends BaseChart3D {
